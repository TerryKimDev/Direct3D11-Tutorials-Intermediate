...
HRESULT InitContent()
{
	...
	//////////////////////////////////////////
	{
		...
		meshRenderable.setPosition(-3.0f, 0.75f, -1.0f);
		renderables.push_back(meshRenderable);

		// make a second duck, push_back makes a copy
		meshRenderable.setPosition(4.0f, 0.25f, -0.75f);
		meshRenderable.setRotation(XMMatrixRotationY(2.35579f));
		renderables.push_back(meshRenderable);

		// make a third duck, push_back makes a copy
		meshRenderable.setPosition(3.0f, 2.5f, 4.0f);;
		meshRenderable.setRotation(XMMatrixRotationY(3.14159265359f/2));
		renderables.push_back(meshRenderable);
	}
	...
	// these should become a create Renderable funcition
	{
		...
		meshRenderable.setPosition(0.35f, 0.0f, 0.0f);
	...
	//////////////////////////////////////////
	{
		...
		meshRenderable.setPosition(-2.5f, 0.0f, 4.0f);
		meshRenderable.setRotation(XMMatrixRotationY(3.14159265359f));
		renderables.push_back(meshRenderable);
	}
	...
	//////////////////////////////////////////
	{
		...
		// Load it!
		LoadFBX("..//Assets//cube.fbx", mesh, 0.025f, filename);
		...
		meshRenderable.setPosition(3.0f, 0.0f, 4.0f);
		meshRenderable.setRotation(XMMatrixRotationY(3.14159265359f));
		renderables.push_back(meshRenderable);
	}
	...
	//////////////////////////////////////////
	{
		...
		meshRenderable.setPosition(-3.0f, 1.0f, 0.0f);
		meshRenderable.setRotation(XMMatrixRotationY(3.14159265359f/2));
		renderables.push_back(meshRenderable);
	}

	//////////////////////////////////////////
	//Create boat components
	//////////////////////////////////////////
	{
		Renderable meshRenderable;
		...
		// Load it!
		LoadFBX("..//Assets//rowing_boat_tris.fbx", mesh, 0.007f, filename);
		...
		meshRenderable.setPosition(3.5f, 0.0f, -1.5f);
		meshRenderable.setRotation(XMMatrixRotationY(2.35579f));
		renderables.push_back(meshRenderable);
	}
	...
	//////////////////////////////////////////
	{
		...
		meshRenderable.setPosition(-1.0f, 0.0f, -3.0f);
		renderables.push_back(meshRenderable);

		meshRenderable.setPosition(-0.5f, 0.0f, -3.0f);
		renderables.push_back(meshRenderable);
